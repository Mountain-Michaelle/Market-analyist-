...
const Hero = () => {
  ...
  <div className="text-center max-w-[90%] md:max-w-[70%]">
    <h1 className="text-4xl text-center sm:text-6xl font-extrabold animate-pulse duration-1000 md:text-5xl lg:text-7xl bg-gradient-to-r p-2 from-black to-blue-600 bg-clip-text text-transparent">
      Know. Analyze. Decide.
    </h1>
